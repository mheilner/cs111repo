...
def distance(city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    xA, xB, yA, yB = get_lat(city_a), get_lat(city_b), get_lon(city_a), get_lon(city_b)
...
def closer_city(lat, lon, city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    tCity = make_city('Test', lat, lon)
    if distance(tCity, city_a) < distance(tCity, city_b):
